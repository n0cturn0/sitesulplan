  ...
  <body>
    ...
    <div class="page">
      ...
      <?php
       ...
       $metas = "SELECT texto FROM inicial where id=4";
        ...
        <div class="container">
          <div class="row justify-content-md-center">
           ...
           <div class="block-1 pe-xl-70">
                  ...
                  <h5 class="footer-modern-title">Página Principal -  Perfil</h5>
                  
                </div>
                <form   method="post" action="update_fazemos.php" enctype="multipart/form-data">
                <div class="col-12">
                    <div class="form-wrap">
                     ...
                     <?php foreach( $rows as $fazemos) { echo $fazemos['texto']; } ?>
                      </textarea>
                    </div>
                  </div>
